...
export const THEME_SIMPOSIO = [
  {
    id: 1,
    name:
      "I - A Didática como campo epistemológico e disciplinar",
  },
  {
    id: 2,
    name:
      "II - A Didática e os Saberes docentes estruturantes na formação de professores",
  },
  {
    id: 3,
    name:
      "III - A Didática e as tecnologias da informação e comunicação no currículo e práticas de ensino",
  },
  {
    id: 4,
    name:
      "IV - A Didática e Práticas de Ensino na perspectiva da Educação como Direito Constitucional e os desafios políticos da atualidade",
  },
  {
    id: 5,
    name:
      "V - A Didática e as Práticas de ensino nas políticas de formação de Pedagogos(as)",
  },
  {
    id: 6,
    name:
      "VI - A Didática e as Práticas de Ensino nos cursos de Licenciatura: entre tensionamentos e perspectivas",
  },
  { id: 7, name: "VII - A Didática, Práticas de Ensino - Infâncias, Juventudes e Vida Adulta" },
  { id: 8, name: "VIII - A Didática, Práticas de Ensino, Educação das Relações Étnico-raciais, Diversidade e Inclusão Escolar" },
  { id: 9, name: "IX - A Didática da Educação Superior" },
];
